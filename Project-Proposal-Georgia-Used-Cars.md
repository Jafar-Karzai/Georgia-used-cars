...
**Prepared for**: Mr. Hedayatullah Nasimi   
**Company**: Georgia Used Cars, Sharjah, UAE   
**Date**: 9th November 2025   
**Prepared by**: Jafar Karzai
...
- Automated invoice generation with UAE VAT compliance (5% rate \- for local market)  
...
#### **Creative & Professional Vehicle Showcase**
...
- Clean, minimalist design inspired by best in class  
...
### **Phase 4: Customer & Sales Management (2 Weeks)**
...
### **Phase 5: Advanced Features & Reports (2 Weeks)**
...
**Total Platform Development**: **AED 40,000**  
**Timeline: 12 weeks from first payment to deployment**   
**Payment Structure:**

- **Phase 1 (Upon confirming the project)**: **AED 20,000 (50%)**  
  - Work-in-progress & already delivered includes:  
    - Complete database architecture and vehicle status system  
    - "Arriving Soon" and "Arrived" status categorization  
    - Public website with basic architecture design  
    - Admin panel with role-based authentication & vehicle management  
    - Platform deployed live on Render  
- **Phase 2 (Upon deployment & delivery)**: **AED 20,000 (50%)**  
  - Final payment upon successful deployment, testing, and handover  
...
- **Comprehensive training** and 3 months free support
...
- **Junior developer in UAE:** AED 150-200/hour  
- **Senior full-stack developer in UAE:** AED 300-500/hour  
- **Budget developers:** AED 15-25K (6-9 months delivery, incomplete features, requires fixes), **risk of redoing everything**.  

**Quick Math:**

- **24 Weeks of work (6 Months):** 120 days (5-day week)  
- **If working 8 hours/day:** 960 hours   
- **Junior developer would do it for:** 150-200/hour X 960 hours \= **AED 144,000-192,000**    
- **Senior developer would do it for:** 300-500/hour X 960 hours \= **AED 288,000-480,000**


	**If done quicker;**

- **12 Weeks of work (3 Months):** 60 days (5-day week)  
- **If working 8 hours/day:** 480 hours   
- **Junior developer would do it for:** 150-200/hour X 960 hours \= **AED 72,000-96,000**    
- **Senior developer would do it for:** 300-500/hour X 960 hours \= **AED 144,000-240,000**
...
- **Previous successful delivery** for Lucky Island Motors with excellent results  
...
1. **Project approval** and initial payment (Phase 1\)  
...
- **Week 12**: Final deployment and training completion
...
**Jafar Karzai**: Available for immediate consultation

- Email: [jafar.karzai@gmail.com](mailto:jafar.karzai@gmail.com)   
- Phone: \+971 52 244 8485

**Project Start Date**: Already in progress, **Estimated Completion**: 12 weeks from project initial payment, **Total Investment**: AED 40,000 (milestone-based payments)
